function out = convert2blocks_en_CScan( im, car )
...
Block1 = encryptBlockCScan(Block1, CarBlock1);
Block2 = encryptBlockCScan(Block2, CarBlock1);
Block3 = encryptBlockCScan(Block3, CarBlock1);
Block4 = encryptBlockCScan(Block4, CarBlock1);
